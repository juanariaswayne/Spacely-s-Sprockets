...
const textLog = `reference 70.0 45.0 6
thermometer temp-1
...
const expectedResult = '{"temp-1":"precise","temp-2":"ultra precise","hum-1":"keep","hum-2":"discard","mon-1":"keep","mon-2":"discard"}';

test('Evaluate Log File', () => {
  expect(evaluateLogFile(textLog)).toBe(expectedResult);
});
